<x-app-layout>
         ...
         <div class="w-full mx-4 flex flex-col justify-between">
            ...
            <div class="flex items-center justify-between mt-6">
               <div class="flex items-center text-xs text-subtext1 font-semibold space-x-2">
                  <div class="font-bold text-maroon">Author</div>
                  <div>&bull;</div>
               ...
               <div
                  ...
                  >
                     ...
                     >
                        ...
                        <li><a href="#" class="hover:bg-overlay2 block transition ease-in duration-150 px-5 py-3">Delete post</a></li>
                     </ul>
                  </button>
               </div>
            </div>
   ...
   <div class="buttons-container flex items-center justify-between mt-6">
            ...
            >
               <form action="#" class="space-y-4 px-4 py-6">
                  <div>
                     ...
                     class="w-full text-sm bg-overlay1 rounded-xl placeholder-maroon border-none px-4 py-2 focus:outline-none focus:ring focus:ring-maroon" placeholder="Go ahead. Share your thoughts..."></textarea>
                  </div>
                  <div class="flex items-center space-x-3">
                     <button type="button" class="flex items-center justify-center h-11 w-1/2 text-xs text-base bg-maroon font-semibold rounded-xl border border-maroon hover:border-overlay0 transition duration-150 ease-in px-6 py-3">        
                        <span>Post Comment</span>
                     </button>
                     <button type="button" class="flex items-center justify-center w-1/2 h-11 text-xs bg-overlay0 font-semibold rounded-xl border border-overlay0 hover:border-maroon transition duration-150 ease-in px-6 py-3">
                  ...
                  <div class="space-y-2">
                     <div>
                        <label class="inline-flex items-center">
                           <input type="radio" checked="" class="text-maroon border-none bg-text focus:outline-none focus:ring focus:ring-maroon" name="status" value="1">
                           <span class="ml-2">Open</span>
                        </label>
                     </div>
                     <div>
                        <label class="inline-flex items-center">
                           <input type="radio" checked="" class="text-mauve border-none bg-text focus:outline-none focus:ring focus:ring-maroon" name="status" value="1">
                           <span class="ml-2 text-mauve">Considering</span>
                        </label>
                     </div>
                     <div>
                        <label class="inline-flex items-center">
                           <input type="radio" checked="" class="text-yellow border-none bg-text focus:outline-none focus:ring focus:ring-maroon" name="status" value="1">
                           <span class="ml-2 text-yellow">In Progess</span>
                        </label>
                     </div>
                     <div>
                        <label class="inline-flex items-center">
                           <input type="radio" checked="" class="text-green border-none bg-text focus:outline-none focus:ring focus:ring-maroon" name="status" value="1">
                           <span class="ml-2 text-green">Implemented</span>
                        </label>
                     </div>
                     <div>
                        <label class="inline-flex items-center">
                           <input type="radio" checked="" class="text-red border-none bg-text focus:outline-none focus:ring focus:ring-maroon" name="status" value="1">
                     ...
                     <div class="flex items-center justify-between space-x-3">
                        ...
                        <button type="submit" class="flex items-center justify-center w-1/2 h-11 text-xs text-base bg-maroon font-semibold rounded-xl border border-maroon hover:border-overlay0 transition duration-150 ease-in px-6 py-3">                      
                            <span class="ml-1">Update</span>
                        </button>
                    </div>
                    <div>
                        <label class="font-normal inline-flex items-center">
                            <input type="checkbox" name="notify_voters" class="rounded bg-text text-maroon focus:outline-none focus:ring focus:ring-violet-300" checked="">
      ...
      <div class="flex items-center space-x-4 ml-6">
         ...
         <button type="button" class="flex items-center justify-center h-11 w-32 text-xs text-base bg-maroon font-semibold rounded-xl border border-maroon hover:border-overlay0  transition duration-150 ease-in px-6 py-3">      
