<div class="flex items-center space-x-4 hover:underline">
...
>
        ...
        <ul
            class="absolute w-76 md:w-96 text-left text-text text-sm bg-surface1 shadow-dialog rounded-xl max-h-128 overflow-y-auto z-10 -right-28 md:-right-12"
            {{-- style="right: -46px" --}}
            x-cloak
            x-show="isOpen"
        ...
        @endforeach
            <li class="border-t border-gray-300 text-center">
                ...
                @click="isOpen = false"
                class="w-full block font-semibold hover:bg-overlay0 transition duration-150 ease-in px-5 py-4">
                    Mark all as read
                </button>
            </li>
             @elseif ($isLoading)
