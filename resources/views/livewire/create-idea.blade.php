<div>
    ...
    @else
        <div class="my-6 text-center">
            ...
            href="{{ Route('login') }}" class="inline-block justify-center w-1/2 h-11 text-xs text-base bg-maroon font-semibold rounded-xl border border-maroon hover:border-overlay0 transition duration-150 ease-in px-6 py-3">
            <span class="ml-1">Login</span>
            </a>
            <a
            wire:click.prevent="redirectToRegister"
            href="{{ Route('register') }}" class="inline-block justify-center w-1/2 h-11 text-xs bg-overlay0 font-semibold rounded-xl border border-overlay0 hover:border-maroon transition duration-150 ease-in px-6 py-3 mt-4">
