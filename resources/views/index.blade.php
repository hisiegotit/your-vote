            ...
            <div class="w-full mx-4">
               ...
               <div class="flex items-center justify-between mt-6">
                  ...
                  <div class="flex items-center space-x-2">
                     <div class="bg-gray-200 text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4  transition duration-150 ease-in">Open</div>
                  </div>
                  <div
                     x-data="{ isOpen: false }"
                  ...
                  >
                     ...
                     <ul
                        ...
                        class="absolute w-38 font-semibold bg-white shadow-dialog rounded-xl py-3 ml-4"
                     >
