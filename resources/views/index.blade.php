<x-app-layout>
   <div class="filters flex space-x-6">
      ...
      <div class="w-2/3 relative">
         <input type="search" placeholder="Find idea" class="w-full rounded-xl px-4 py-2 pl-8 border-none placeholder-maroon bg-surface1">
         <div class="absolute top-0 flex items-center h-full ml-2">
            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 text-maroon">
   ...
   <div class="ideas-container space-y-6 my-6">
      <div class="idea-container hover:shadow-card transition ease-out duration-150 bg-surface0 rounded-xl flex cursor-pointer">
         <div class="border-r border-maroon px-5 py-8">
            ...
            <div class="mt-8">
               <button class="w-20 bg-overlay0 font-bold text-xxs uppercase rounded-xl px-4 py-3 transition ease-in duration-150 border border-overlay0 hover:border-maroon">
                  Vote
               </button>
            </div>
         </div>
            ...
            <div class="w-full flex flex-col justify-between mx-4">
               ...
               <div class="flex items-center justify-between mt-6">
                  ...
                  <div class="flex items-center space-x-2">
                     <div class="bg-overlay0 text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4 transition duration-150 ease-in border border-overlay0 hover:border-maroon">Open</div>
                  </div>
                  <div
                     x-data="{ isOpen: false }"
